...
//
// include list of Multi protocols
//
...
//
STRLIST(STR_SUBTYPE_FLYSKY,    {"Flysky","V9x9","V6x6","V912","CX20"})
...
STRLIST(STR_SUBTYPE_MT99,      {"MT","H7","YZ","LS","FY805","A180","Dragon","F949G"})
...
STRLIST(STR_SUBTYPE_JJRC345,   {"JJRC345","SkyTmblr"})
