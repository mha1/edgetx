...
const struct YamlIdStr enum_MixSources[] = {
  ...
  {  MIXSRC_SPACEMOUSE_1, "SPACEMOUSE_1"  },
  {  MIXSRC_SPACEMOUSE_2, "SPACEMOUSE_2"  },
  {  MIXSRC_SPACEMOUSE_3, "SPACEMOUSE_3"  },
  {  MIXSRC_SPACEMOUSE_4, "SPACEMOUSE_4"  },
  {  MIXSRC_SPACEMOUSE_5, "SPACEMOUSE_5"  },
  {  MIXSRC_SPACEMOUSE_6, "SPACEMOUSE_6"  },
  {  MIXSRC_MAX, "MAX"  },
  {  MIXSRC_CYC1, "CYC1"  },
  {  MIXSRC_CYC2, "CYC2"  },
  {  MIXSRC_CYC3, "CYC3"  },
